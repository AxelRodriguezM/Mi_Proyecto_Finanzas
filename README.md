# 📈 Dashboard de Estrategia de Inversión (Golden Cross)
...
### Características:
* **Datos Reales:** Descarga automática desde Yahoo Finance API.
* **Backtesting:** Simulación histórica de ganancias y pérdidas.
* **Análisis de Riesgo:** Cálculo de Maximum Drawdown.
* **Interactivo:** Creado con Streamlit para modificar parámetros en tiempo real.
